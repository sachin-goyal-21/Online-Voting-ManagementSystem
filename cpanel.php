          ...
          <div class="col-sm-12">
            <?php
              ...
              else
              {
                ...
                // SP
                $sql ="SELECT * FROM tbl_users WHERE voted_for='SP'";
                $result= mysqli_query($conn, $sql);
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "<strong>Samajwaadi Party</strong><br>";
                  echo "
                  <div class='progress'>
                    <div class='progress-bar progress-bar-warning' role='progressbar' aria-valuenow=\"70\" aria-valuemin=\"0\" aria-valuemax=\"100\" style='width: ".$sp_value."%'>
